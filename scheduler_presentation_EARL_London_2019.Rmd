...
```{r, echo=FALSE}
include_my_hex <- function(){
  knitr::include_graphics("https://raw.githubusercontent.com/jameslairdsmith/gs_presentation/master/gs_hex_sticker.png")}
```

```{r, echo=FALSE}
include_earl_logo <- function(){
  knitr::include_graphics("https://raw.githubusercontent.com/jameslairdsmith/gs_presentation/master/gs_hex_sticker.png")}
```
